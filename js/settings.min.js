...
i18n.init(function(a){$(".widget-wrapper").i18n().show();$(".form-control").selectpicker();$(".sticky-buttons").sticky({container:$(".widget-wrapper"),topSpacing:41,getWidthFrom:$(".widget-wrapper")})})})};
